import { Controller, Post, Body, UploadedFile, UseGuards, UseInterceptors, Req, HttpException, HttpStatus, Delete, Param, Get } from '@nestjs/common';
...
export class ImagesController {
    ...
    async createPortfolio(@Req() req: Request, @Body() dto: CreateImageDto, @UploadedFile() file) {
